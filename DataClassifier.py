...
# Loading the Data
df = pd.read_excel(r'D:/Data/Iris_dataset.xlsx') #pip install openpyxl
...
def train(num_epochs): 
    ...
    for epoch in range(1, num_epochs+1): 
        ...
        print('best accuracy=',best_accuracy,'accuracy=',accuracy)
...
def convert(): 
    ...
    dummy_input = torch.randn(1, 3, 3, 4, requires_grad=True)  #different from example!!!
    # Export the model   
    torch.onnx.export(model,  dummy_input,  "Network.onnx",export_params=True,opset_version=11,do_constant_folding=True,input_names = ['input'],output_names = ['output'],dynamic_axes={'input' : {0 : 'batch_size'}, 'output' : {0 : 'batch_size'}}) # variable length axes
    print(" ") 
